...
contract Students {
    ...
    modifier isOnlyTeacher{
        require(msg.sender == teacher);
        _;
    }
    
    function setMultipleTeachersAsAdmins(address _newTeacherAddress) public isOnlyTeacher {
        multiTeachers[_newTeacherAddress] = true;
    }
    
    function removeTeacherAsAdmin(address _newTeacherAddress) public isOnlyTeacher {
   ...
   function setNewTeacher(address _newTeacherAddress) public isOnlyTeacher {
   ...
   function updateStudentDetails(address _stdAddress, uint8 _rollno, uint8 _percentage) payable public {
    ...
    function setAttendance(address _stdAddress,uint8 _classno) public isOnlyTeacher {
    ...
    function addStudentDetails(address _stdAddress,uint8 _rollno,uint8 _percentage) public isOnlyTeacher {
